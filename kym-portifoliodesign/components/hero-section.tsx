...
export function HeroSection() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background to-card px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground text-balance leading-relaxed">
              Specialized in electrical power systems, motor control, industrial automation, and field engineering with 6+ years of hands-on experience. MATLAB & AutoCAD proficient with a passion for solving complex engineering challenges.
            </p>
          ...
          <div className="hidden md:flex justify-center">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-accent/30 to-accent/10 rounded-full blur-2xl"></div>
              <div className="relative w-80 h-80 rounded-full overflow-hidden border-4 border-accent/40 shadow-2xl">
                <img
                  src="/profile.jpeg"
